...
print("increased depth count: " +
      str(count_increase(get_formatted_inputs(file_name))))
print("increased depths of sums: " +
      str(count_increase(get_sums(get_formatted_inputs(file_name)))))
